...
from sklearn.metrics import accuracy_score, confusion_matrix, auc, roc_curve, precision_recall_fscore_support, \
...
def get_args():
    ...
    parser.add_argument('--root_path', type=str, default='/media/scw4750/liuxiuhan/jingxilong/Autoformer-main/dataset/',
...
def main(args):
    ...
    g = torch.Generator()
    g.manual_seed(seed)
    test_loader = DataLoader(test_data, batch_size=800, shuffle=False, num_workers=args.num_workers)
    if args.gpu is not None:
    ...
    accuracy, fp, fn, auc_score, pr_auc, precision_test, recall_test, fpr, fnr, f1 = evaluate(true_label, predictions,
                                                                                              model_output)
